...
import { addCorporate,reset } from '../features/admin/adminSlice'
    ...
    if(isLoading){
      ...
      return (
        <div className='form-group'>
            <h2 className='heading'>Add Admin</h2>
            <h4 className='heading'>Step 1: please enter username and password</h4>
